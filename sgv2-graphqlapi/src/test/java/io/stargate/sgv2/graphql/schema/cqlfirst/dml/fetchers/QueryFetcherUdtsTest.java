  ...
  public static Arguments[] successfulQueries() {
    return new Arguments[] {
      arguments(
          ...
          "SELECT a FROM udts.\"TestTable\" WHERE a = :\"a\"",
          ImmutableMap.of("a", udtA(udtB(1)))),
      arguments(
      ...
      arguments(
          ...
          "SELECT a FROM udts.\"TestTable\" WHERE a IN :\"a\"",
          ImmutableMap.of("a", listV(udtA(udtB(1)), udtA(udtB(2))))),
    };
  }
