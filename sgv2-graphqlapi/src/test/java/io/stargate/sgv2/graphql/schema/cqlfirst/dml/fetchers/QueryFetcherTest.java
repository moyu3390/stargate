  ...
  public static Arguments[] successfulQueries() {
    return new Arguments[] {
      ...
      arguments(
          ...
          "SELECT title, author FROM library.books LIMIT :\"limit\"",
          ImmutableMap.of("limit", Values.of(10))),
      arguments(
          "books(filter: { title: { eq: \"The Road\" } }) { values { title, author } }",
          "SELECT title, author FROM library.books WHERE title = :\"title\"",
          ImmutableMap.of("title", Values.of("The Road"))),
      arguments(
    ...
    return new Arguments[] {
      arguments(
          ...
          QueryParameters.newBuilder(defaults)
              ...
              .setPagingState(
                  BytesValue.of(ByteString.copyFrom(Base64.getDecoder().decode("AWEA8H////4A"))))
              .setConsistency(
